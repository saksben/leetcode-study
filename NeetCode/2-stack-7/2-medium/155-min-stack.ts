...
class MinStack {
  ...
  push(val: number): void {
    ...
    // If minStack is empty OR val <= current min, push onto minStack as well
    if (
  ...
  // Pop most recent values for both stack and min (if also current min, otherwise it will keep the current min that doesn't exist in stack)
  pop(): void {
